...
namespace parquessadoCidade2
{
    public class TrataCliente
    {
        ...
        mensagem=null;
        	...
        	matriculas[0]=new Matricula("zona 1", "12-56-mq", "01-01-2030");
        	matriculas[1]=new Matricula("zona 1", "30-31-sm", "01-01-2030");
        	matriculas[2]=new Matricula("zona 2", "39-33-aa", "01-01-2030");
        	matriculas[3]=new Matricula("zona 2", "90-19-zz", "01-01-2030");
        	matriculas[4]=new Matricula("zona 3", "01-05-mm", "01-01-2030");
        	matriculas[5]=new Matricula("zona 3", "17-15-rr", "01-01-2030");
        	matriculas[6]=new Matricula("zona 1", "08-05-rm", "01-01-2030");
        	matriculas[7]=new Matricula("zona 1", "11-50-gd", "01-01-2030");
           ...
           data = new byte[1024];
            ...
            {        
                ...
                if(hello.Equals("ordens")){
                	...
                	rdm=rand.Next(3)+1;
                	mensagem="Cidade 2 > Vai para a zona "+rdm;
